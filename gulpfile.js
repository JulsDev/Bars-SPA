...
// дефолтный таск
task("default", series("clean", parallel("copy:html", "copy:fonts", "copy:images", "copy:video", "sprite", "styles", "scripts"), "server"));

//task("default", series("clean", parallel("copy:html", "copy:fonts", "copy:images", "copy:video", "styles", "scripts"), "server"));
